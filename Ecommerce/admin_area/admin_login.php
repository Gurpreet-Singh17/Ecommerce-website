...
@session_start(); //it will start for this page only
?>
    ...
    <div class="container-fluid m-3">
        ...
        <div class="row d-flex justify-content-center ">
            <div class="col-lg-6 col-xl-5">
                <img src="../images/adminreg.jpg" alt="Admin Registration" class="image-fluid ">
            </div>
...
if(isset($_POST['admin_login'])){
    ...
    if($row_count>0){  //user is present inside database
